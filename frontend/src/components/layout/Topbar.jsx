      ...
      <div className="px-6 py-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-12 pr-4 py-3 w-full md:w-80 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                value={searchQuery}
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="bg-purple-600 hover:bg-purple-700 text-white px-5 py-2.5 rounded-xl font-medium flex items-center space-x-2 transition-colors">
