      ...
      >
        ...
        >
          ...
          <motion.div variants={scaleIn}>
            ...
            {/* Google Login Button - Redesigned as clear button */}
            <motion.button
              type="button"
              onClick={handleGoogleLogin}
              disabled={isLoading}
              className="w-full flex items-center justify-center space-x-3 bg-white hover:bg-gray-50 text-gray-700 py-3.5 px-4 rounded-xl font-medium border-2 border-gray-300 hover:border-blue-400 shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-70"
            ...
            <p className="text-center text-xs text-gray-500 mt-3">
              Gunakan email <span className="font-semibold">@polije.ac.id</span> atau <span className="font-semibold">@student.polije.ac.id</span>
            </p>
          </motion.div>
