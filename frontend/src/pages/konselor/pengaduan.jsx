                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6">
                            {complaints.map(c => (
                                <div key={c.id} className="group bg-white rounded-[32px] shadow-sm hover:shadow-xl hover:shadow-purple-500/5 hover:-translate-y-2 border border-gray-100/80 transition-all duration-300 overflow-hidden flex flex-col h-full">
                                    ...
                                    <div className="px-7 py-5 bg-gray-50/50 border-t border-gray-100 grid grid-cols-3 gap-2 opacity-90 group-hover:opacity-100 transition-opacity">
                                        <button
                                        ...
                                        >
                                            <FiCalendar size={14} /> Atur Jadwal
                                        </button>
                                    </div>
                                </div>
                            ))}
                    ...
                    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                        ...
                        <div className="relative bg-white rounded-[40px] shadow-2xl w-full max-w-md p-10 animate-in zoom-in-95 duration-200">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button disabled={isSubmitting || (statusModal.status === 'rejected' && !statusModal.rejection_reason.trim())} onClick={submitStatus} className="flex-1 py-4 bg-blue-600 text-white rounded-3xl text-sm font-bold hover:bg-blue-700 shadow-xl shadow-blue-500/20 disabled:opacity-50 transition-all active:scale-95">{isSubmitting ? 'Menyimpan...' : 'Simpan'}</button>
                            </div>
                        </div>
                    </div>
                )}
                ...
                {scheduleModal.open && scheduleModal.complaint && (
                    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                        ...
                        <div className="relative bg-white rounded-[40px] shadow-2xl w-full max-w-md p-10 animate-in zoom-in-95 duration-200">
                            ...
                            <div className="flex gap-4">
                                <button disabled={isSubmitting} onClick={() => setScheduleModal({ open: false, complaint: null, counseling_schedule: '' })} className="flex-1 py-4 border-2 border-gray-100 text-gray-400 rounded-3xl text-sm font-bold hover:bg-gray-50 transition-all">Batal</button>
