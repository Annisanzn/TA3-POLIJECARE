...
const OperatorManualCounseling = () => {
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] font-['Poppins'] overflow-hidden transition-colors duration-500">
      <style>{`
      ...
      {/* Sidebar */}
      <div className="flex-none h-full overflow-y-auto no-scrollbar border-r border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 transition-all z-40 relative">
